...
Participants in the study also completed a pre-test on the morning of the experiment and a post-test the next day.
The results of the pre and post-test are included with the data.

Their teachers paired the students selected for the collaborative tasks to ensure that the students collaborate effectively.
