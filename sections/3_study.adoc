...
The code was based on a code comprehension task developed by Hansen citenp:[hansenQuantifyingProgramComplexity2013], and the EMIP researchers translated code from python two Scala, and Java.
