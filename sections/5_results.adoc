...
.The four best pipelines by NRMSE per dataset and whether they used PCA or LASSO. xref:pipelines_nrmses_dim_reduction[] and xref:pipelines_nrmses_features[] are the same table with different labels.
