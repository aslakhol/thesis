...
.The pipelines with the five lowest NRMSES per dataset and if they used dimensionality reduction or feature selection
...
.NRMSE Rank and mean NRMSE for PCA and LASSO across all 1-to-1 pipelines
...
.NRMSE Rank and mean NRMSE for PCA and LASSO across all 2-to-1 pipelines
[format="csv", options="header"]
|===
