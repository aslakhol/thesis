...
.The four best pipelines by NRMSE per dataset and whether they used dimensionality reduction or feature selection. xref:pipelines_nrmses_dim_reduction[] and xref:pipelines_nrmses_features[] are the same table with different labels.
...
.The four best pipelines by NRMSE per dataset and their feature group. xref:pipelines_nrmses_dim_reduction[] and xref:pipelines_nrmses_features[] are the same table with different labels.
