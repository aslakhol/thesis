...
Repetetiveness indicates a flow which suggests that the subject is comfortable in their task as opposed to more chaotic non-repetetive behaviour that might occour when one is not comfortable.
We suggest that this relationship should be represented across contexts and hence, could be a reason why spectral histograms seem to generalize quite well.
