...
Intrinsic and extraneous cognitive load are determined by the characteristics of the material, the complexity of the information and the presentation respectively, which are both context specific factors.
As opposed to germane load which is concerned with the subjects personal characteristics and would likely be more generalizable.
Our observations that LHIPA can produce context-sensitive pipelines indicate that LHIPA might captures the extraneous or intrinsic aspects of cognitive load.
