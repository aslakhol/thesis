...
Modern adaptive systems rely on understanding the current cognitive capabilities of users.
However, these systems rely primarily on tailor-made solutions to detect such capabilities.
