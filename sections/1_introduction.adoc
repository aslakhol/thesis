...
Universality and generalism of research is an important concept, and its role in information systems research is an ongoing debate citenp:[davisonContextKingConsidering2016, chengContextMayBe2016].
