...
Our code is available at https://github.com/s0lvang/ideal-pancake under the MIT License citenp:[MITLicense].
If there are any questions or bugs regarding the code, please open an issue.
The text of this thesis can be found at https://github.com/aslakhol/thesis.
