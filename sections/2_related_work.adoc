...
While the use of machine learning pipelines to automate the many steps involved in producing a machine learning model have obtained little attention in academia the techinques are still used and more research is emerging recently citenp:[mohrPredictingMachineLearning2021, romanMachineLearningPipeline2021].
