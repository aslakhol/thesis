...
Kidzinski et al. discuss how the bias-variance trade-off is a central concern when studying generalizability in the context Massive Open Online Courses (MOOCs) citenp:[lukaszGeneralizabilityMOOCModels2016].
