...
Many studies have been published that demonstrate that ensemble methods frequently improve on the average performance of the single regressor citenp:[CombiningPatternClassifiers, anOptimalWeightSelectionRegressor2009].
...
NRMSE is commonly used in learning technologies to evaluate learning predictions citenp:[moreno-marcosPredictionMOOCsReview2019]  and is the preferred metric for student models. citenp:[pelanekMetricsEvaluationStudent2015]
